...
CSG.prototype = {
  ...
  toX3D: function() {
    ...
    this.polygons.map(function(p) {
      var red = 0; var green = 0; var blue = 1;  // default color is blue
      ...
      polygonString = polygonVertexIndices.join(" ");
    ...
    exportDoc.insertBefore(exportDoc.createProcessingInstruction('xml','version="1.0" encoding="UTF-8"'),
                           exportDoc.doctype);
    ...
    exportRoot.setAttribute("xsd:noNamespaceSchemaLocation",
    ...
    */
    ...
    return new Blob([x3dstring], {type: "model/x3d+xml"});
  },
  ...
  toStlBinary: function() {
    ...
    return new Blob([headerarray.buffer, ar1.buffer, allTrianglesBuffer], {type: "application/sla"});
  },
...
CAG.PathsToDxf = function(paths) {
  ...
  str += "  0\nENDSEC\n  0\nEOF\n";
  return new Blob([str], {type: "application/dxf"});
};
